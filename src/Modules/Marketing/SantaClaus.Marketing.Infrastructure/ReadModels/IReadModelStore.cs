...
public interface IReadModelStore
{
    ...
    /// <summary>
    /// Add a notification to the read model store.
    /// </summary>
    void AddNotification(NotificationDto notification);

    /// <summary>
    /// Get notification history for a specific child.
    /// </summary>
    IReadOnlyList<NotificationListItemDto> GetNotificationsByChild(Guid childId);
